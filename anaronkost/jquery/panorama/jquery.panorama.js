	...
	$.fn.panorama = function(options) {
		this.each(function(){ 
			...
			panoramaContainer.css('height', elemHeight+'px').css('overflow', 'hidden').wrap("<div class='panorama-viewport'></div>").parent().css('width',settings.viewport_width+'px')
				.append("<div class='panorama-control'><a href='#' class='panorama-control-left'><<</a> <a href='#' class='panorama-control-pause'>x</a> <a href='#' class='panorama-control-right'>>></a><a href='#' class='panorama-map'>map</a></div>");
			...
			//test
			panoramaViewport.find('a.panorama-map').bind('click', function() {
				$.blockUI({ message: $('#mappopup'), css: { width: '275px', left:'30%', top:'2%' } }); 
